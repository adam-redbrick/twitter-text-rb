...
module Twitter
  ...
  class Regex
    ...
    REGEXEN[:valid_gTLD] = /(?:(?:aero|asia|biz|cat|com|co|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)(?=[^0-9a-z]|$))/i
    REGEXEN[:valid_ccTLD] = %r{
      (?:
        ...
        ci|ck|cl|cm|cn|cr|cs|cu|cv|cx|cy|cz|dd|de|dj|dk|dm|do|dz|ec|ee|eg|eh|er|es|et|eu|fi|fj|fk|fm|fo|fr|ga|gb|gd|ge|gf|gg|gh|gi|gl|gm|
